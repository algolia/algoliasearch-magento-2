...
<code>*/5 * * * * php /absolute/path/to/magento/bin/magento algolia:reindex:process_queue</code> <br/><br/> <span class="algolia-config-warning">&#9888;</span> Enabling this option is recommended in production or if your store has a lot of products. ';
    }
}
