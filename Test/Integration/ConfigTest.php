...
class ConfigTest extends TestCase
{
    ...
    {
        /** @var IndicesConfigurator $indicesConfiurator */
        $indicesConfiurator = $this->getObjectManager()->create(IndicesConfigurator::class);
        $indicesConfiurator->saveConfigurationToAlgolia(1);
